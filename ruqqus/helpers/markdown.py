...
class CustomRenderer(HTMLRenderer):
    ...
    def render_emoji(self, token):
        ...
        if os.path.isfile(f"/home/ubuntu/ruqqus/ruqqus/assets/images/emojis/{name}.gif"):
            ...
            return f'<span data-toggle="tooltip" data-original-title=":{name}:"><img class="emoji" src="/assets/images/emojis/{name}.gif"></span>'
        
        elif g.v.has_premium and os.path.isfile(f"/home/ubuntu/ruqqus/ruqqus/assets/images/primojis/{name}.gif"):
            
            return f'<span data-toggle="tooltip" data-original-title=":{name}:"><img class="emoji" src="/assets/images/primojis/{name}.gif"></span>'
