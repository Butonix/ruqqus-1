...
class CustomRenderer(HTMLRenderer):
    ...
    def render_user_mention(self, token):
        ...
        return f'{space}<a href="{user.permalink}" class="d-inline-block mention-user" data-original-name="{user.original_name}"><img src="/uid/{user.base36id}/pic/profile" class="profile-pic-20 mr-1">@{user.username}</a>'
