...
//GIFS
  ...
  function loadEmojis() {
      ...
      for (i = 0; i < emojis.length; i++) { 
        str += `<button class="btn my-2 px-2 py-0" onclick="getEmoji(\'${emojis[i]}\')" style="overflow: hidden;"><img width=30 src="/assets/images/emojis/${emojis[i]}.gif" alt="${emojis[i]}-emoji"/></button>`;
      }
