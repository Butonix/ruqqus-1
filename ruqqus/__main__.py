...
#setup db
engines={
    "leader":create_engine(app.config['SQLALCHEMY_DATABASE_URI'], pool_size=20, pool_use_lifo=True),
    "followers":[create_engine(x, pool_size=20, pool_use_lifo=True) for x in app.config['SQLALCHEMY_READ_URIS']]
}
