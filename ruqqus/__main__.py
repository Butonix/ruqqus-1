...
app.config['SQLALCHEMY_READ_URIS']=[
     environ.get("HEROKU_POSTGRESQL_JADE_URL", environ.get("HEROKU_POSTGRESQL_BROWN_URL")),
     environ.get("HEROKU_POSTGRESQL_PINK_URL", environ.get("HEROKU_POSTGRESQL_GOLD_URL"))
     ]
