...
app.config['SQLALCHEMY_READ_URIS']=[
     ...
     environ.get("DATABASE_CONNECTION_POOL_READ_03_URL", environ.get("HEROKU_POSTGRESQL_COPPER_URL")),
     environ.get("DATABASE_CONNECTION_POOL_READ_04_URL", environ.get("HEROKU_POSTGRESQL_PUCE_URL")).
