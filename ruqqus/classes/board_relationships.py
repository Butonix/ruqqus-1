...
class ModRelationship(Base):
    ...
    permQueue = Column(Boolean, default=False)
    permAppearance = Column(Boolean, default=False)
    permUser = Column(Boolean, default=False)
    permOther = Column(Boolean, default=False)
    permAccess = Column(Boolean, default=False)
    permFull = Column(Boolean, default=False)
